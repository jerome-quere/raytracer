...
# Generated by qmake (2.01a) (Qt 4.7.2) on: Tue Sep 27 22:19:27 2011
...
SOURCES       = src/calc/RtCalcColor.cpp \
		...
		src/objects/RtObjectSphere.cpp mocs/moc_RtGuiConfFileDialog.cpp \
		mocs/moc_RtGuiController.cpp \
		mocs/moc_RtGuiMainWindow.cpp
OBJECTS       = objects/RtCalcColor.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) objects/rt1.0.0/ && $(COPY_FILE) --parents src/calc/RtCalcColor.hpp src/calc/RtCalcGenerator.hpp src/calc/RtCalcImage.hpp src/conf/RtConfConf.hpp src/conf/RtConfLoader.hpp src/gui/RtGuiConfFileDialog.hpp src/gui/RtGuiController.hpp src/gui/RtGuiMainWindow.hpp src/math/RtMathDouble.hpp src/math/RtMathEquationSolver.hpp src/math/RtMathLine.hpp src/math/RtMathObject.hpp src/math/RtMathPlane.hpp src/math/RtMathPoint.hpp src/math/RtMathSphere.hpp src/math/RtMathVector.hpp src/objects/RtObjectEye.hpp src/objects/RtObjectObject.hpp src/objects/RtObjectPlane.hpp src/objects/RtObjectSphere.hpp objects/rt1.0.0/ && $(COPY_FILE) --parents src/calc/RtCalcColor.cpp src/calc/RtCalcGenerator.cpp src/calc/RtCalcImage.cpp src/conf/RtConfConf.cpp src/conf/RtConfLoader.cpp src/gui/RtGuiConfFileDialog.cpp src/gui/RtGuiController.cpp src/gui/RtGuiMainWindow.cpp src/main/main.cpp src/math/RtMathDouble.cpp src/math/RtMathEquationSolver.cpp src/math/RtMathLine.cpp src/math/RtMathPlane.cpp src/math/RtMathPoint.cpp src/math/RtMathSphere.cpp src/math/RtMathVector.cpp src/objects/RtObjectEye.cpp src/objects/RtObjectObject.cpp src/objects/RtObjectPlane.cpp src/objects/RtObjectSphere.cpp objects/rt1.0.0/ && $(COPY_FILE) --parents src/gui/RtGuiMainWindow.ui objects/rt1.0.0/ && (cd `dirname objects/rt1.0.0` && $(TAR) rt1.0.0.tar rt1.0.0 && $(COMPRESS) rt1.0.0.tar) && $(MOVE) `dirname objects/rt1.0.0`/rt1.0.0.tar.gz . && $(DEL_FILE) -r objects/rt1.0.0
...
compiler_moc_header_make_all: mocs/moc_RtGuiConfFileDialog.cpp mocs/moc_RtGuiController.cpp mocs/moc_RtGuiMainWindow.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) mocs/moc_RtGuiConfFileDialog.cpp mocs/moc_RtGuiController.cpp mocs/moc_RtGuiMainWindow.cpp
